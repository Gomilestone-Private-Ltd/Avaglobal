...
<html lang="en">
  <head>
    <title>
      Freight forwarding companies in India | Freight forwarders in Mumbai,
      India - AVA Global
    </title>
    <meta
      name="description"
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=UA-107918162-1"
    ></script>
      ...
      <header class="headerblk">
        <div class="wrapper">
          ...
          <div class="headerrightblk">
            ...
            <a href="/login"
              ><img src="./images/use.svg" class="user-icon"
            /></a>
            <a href="#menu"
              ><span class="sprite hamburger" id="menublk"></span
            ></a>
          </div>
          <div class="clear"></div>
        </div>
            ...
            <div class="navigationdes">
              <div class="navlinkblk">
                <ul class="navmainlink">
                  <li><a href="/">Home</a></li>
                  <li>
                    <a href="https://www.avaglobal.in/about.php">ABOUT US</a>
                  </li>
                  <li>
                    <a href="https://www.avaglobal.in/contact.php"
                      >Contact us</a
                    >
                  </li>
              ...
              <div class="navlinkblk">
                <ul class="navmainlink">
                  <li>
                    <a href="https://www.avaglobal.in/services.php">Services</a>
                  </li>
                </ul>

                <ul class="navsubllink">
                  <li>
                    <a href="https://www.avaglobal.in/services/sea-freight.php"
                      >OCEAN FREIGHT</a
                    >
                  </li>
                  <li>
                    <a href="https://www.avaglobal.in/services/air-freight.php"
                      >AIR FREIGHT</a
                    >
                  </li>
                  <li>
                    <a
                      href="https://www.avaglobal.in/services/customs-clearance.php"
                      >CUSTOM CLEARING</a
                    >
                  </li>
                  <li>
                    <a href="https://www.avaglobal.in/services/warehousing.php"
                      >WAREHOUSING</a
                    >
                  </li>
                  <li>
                    <a
                      href="https://www.avaglobal.in/services/heavy-haul-trucking.php"
                      >TRUCKING</a
                    >
                  </li>
                  <li>
                    <a
                      href="https://www.avaglobal.in/services/services-shipping.php"
                      >SHIPPING</a
                    >
                  </li>
                  <li>
                    <a
                      href="https://www.avaglobal.in/services/cargo-insurance.php"
                      >INSURANCE</a
                    >
                  </li>
                </ul>
              ...
              <div class="navlinkblk">
                <ul class="navmainlink">
                  <li>
                    <a href="https://www.avaglobal.in/tariffs-calculators.php"
                      >TARIFFS & CALCULATORS</a
                    >
                  </li>
                </ul>
                ...
                <ul class="navsubllink">
                  <li>
                    <a href="https://www.avaglobal.in/tariffs-calculators.php"
                      >PROCEDURE FOR CLEARANCE OF <br />IMPORTED AND EXPORT
                      GOODS</a
                    >
                  </li>
                  <li>
                    <a href="https://www.avaglobal.in/container-sizes.php"
                      >CONTAINER SIZES</a
                    >
                  </li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.avaglobal.in/services/cargo-insurance.php"
                  >INSURANCE</a
                >
              </li>
            </ul>
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="https://www.avaglobal.in/tariffs-calculators.php"
                  >PROCEDURE FOR CLEARANCE OF <br />IMPORTED AND EXPORT GOODS</a
                >
              </li>
              <li>
                <a href="https://www.avaglobal.in/container-sizes.php"
              ...
              <div class="eva-container">
                ...
                <div class="job-left">  
                    <div class="csd-contnet detail">
                        ...
                        <p class="csdt-content">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source.</p>

                        <h3 class="csdt-title2">Key Responsibilities</h3>
                        <ul class="key-point">
                            <li>You provide ongoing sustaining support to the product, addressing end to end feature enhancements.</li>
                            <li>You provide ongoing sustaining support to the product, addressing end to end feature enhancements.</li>
                            <li>You provide ongoing sustaining support to the product, addressing end to end feature enhancements.</li>
                            <li>You provide ongoing sustaining support to the product, addressing end to end feature enhancements.</li>
                            <li>You provide ongoing sustaining support to the product, addressing end to end feature enhancements.</li>
                ...
                <div class="job-right" id="apply">
                    ...
                    <p class="jr-box"><img src="/images/time.png" class="time-img">Category : <span> Operations</span></p>
                    <p class="jr-box"><img src="/images/time.png" class="time-img">Workday : <span> Full Time</span></p>
                    <p class="jr-box"><img src="/images/time.png" class="time-img">Location : <span> Mumbai</span></p>
                    <p class="jr-box"><img src="/images/time.png" class="time-img">Experience : <span> 5+ Years</span></p>
                ...
                <div class="footerrightblk fr">
                  ...
                  <div class="developblk ibvm">
                    ...
                    <div class="ibvm ddlogo">
                      <a
                        href="http://www.d-designstudio.com/"
                        target="_blank"
                        class="sprite"
                      >
                      </a>
