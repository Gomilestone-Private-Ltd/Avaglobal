...
<div class="headerrightblk">
  ...
  <div id="google_translate_element">
    <img src="./images/language.png" class="language-icon">
  </div>
...
<!-- RESPONSIVE MENU END --><div id="fullpage">
...
<!-- <div class="compshortinfo fr">
<div class="logistic-solution uppercase">logistic solutions & supply chain operations.</div>
</div> -->
</div>
</div>
...
<div class="overvwtagln font-bebas uppercase">your <span>navigators</span> in the world of trade .</div>
<div class="pagetxt">
AVA Global is committed to offer high quality logistics solutions to meet client’sbusiness needs. From air cargo and ocean freight to warehousing, custom clearance,chartering and transportation, we have an extensive portfolio of services to add value and flexibility to our client’s supply chain requirements.
</div>
<a href="/about.html">
...
<div class="overvwtagln font-bebas uppercase">challenges in logistics and supply chain management.</div>
<div class="pagetxt">
In today's highly competitive marketplace, the pressure on organizations is to find new ways to create and deliver value to customers consistently. Provision of efficient logistics solutions and effective supply chain management processes are the ways to achieve cost-reduction and better service for customers.
</div>
<a href="about.php">
<div class="knowmore uppercase">know more
<div class="sprite knwmorearw"></div>
...
<div class="overvwtagln font-bebas uppercase">what outstands<span> ava global?</span></div>
...
<div class="pagetxt">
Our hands-on services and strategic solutions are extensive and customised to meet your every need; whether assisting with expediting an urgent shipment or a strategic partner who can provide competitive terms, identify and create short-term efficiencies and build up long-term competitiveness.
</div>
<a href="/about.html">
...
<a class="prod-morebuts" href="services/customs-clearance.php">KNOW MORE</a>
</div>
</div>
</li>
<li>
...
<img src="/images/services/warehousebg-resp.jpg" alt="" class="img-responsive" />
...
<img src="/images/services/truckingbg-resp.jpg" alt="" class="img-responsive" />
...
<a class="prod-morebuts" href="services/heavy-haul-trucking.php">KNOW MORE</a>
</div>
</div>
</li>
<li>
...
<img src="/images/services/shipping-resp.png" alt="" class="img-responsive" />
...
<a class="prod-morebuts" href="services/services-shipping.php">KNOW MORE</a>
</div>
</div>
</li>
<li>
...
<img src="/images/services/insurancebg-resp.jpg" alt="" class="img-responsive" />
...
<p class="slidetxt"><b>Ava Global Logistics wins 'Emerging Agri Business Logistics Co. of the year 2017' award at Globoil India 2017.</b></p>
</div>
</div>
</li>
<li>
...
405, 4th Floor, Windfall, Sahar Plaza Complex,<br /> J.B Nagar, Andheri - Kurla Road, Andheri (East), <br /> Mumbai - 400059.
</div>
</div>
<div class="contactblk">
...
<div class="contactmobimg"><img src="images/mobile-images/contactinfobg-mob.jpg" alt="" /></div>
</div>
...
<script>
$(".bxslider").bxSlider({auto: !0,autoControls: !0}), $(".bxslideroverview")
.bxSlider({pagerCustom: "#bx-pager",mode: "fade"}), 
$(".bxsliderproduct").bxSlider({pagerCustom: "#product-bx-pager",mode: "fade"}), 
$(".bxslidernews").bxSlider({mode: "fade"}), 
$("#previousPage").click(function(e) {
e.preventDefault(), $.fn.fullpage.moveSectionUp()
}), $("#nextPage").click(function(e) {e.preventDefault(), $.fn.fullpage.moveSectionDown()});
</script>
<script>
...
navigation: true,navigationPosition: 'right',navigationTooltips: ['', '', '', '', '', '', '']});}});
...
<script>
$(document).ready(function() {if ($(window).width() >= 1024) {$('#menublk').click(function() {$('.navigation').addClass('navigationopen')});
$('.closeicon').click(function() {$('.navigation').removeClass('navigationopen')});}
});
</script>
...
$("nav#menu").mmenu({
offCanvas: {position: "right",zposition: "back",moveBackground: "true",},
navbars: [{position: 'top',content: ['prev','title','close']}, ]});}});
</script>
<script>
$(window).load(function() {$("#preloader").delay(1000).fadeOut("slow");});
$(document).ready(function() {
