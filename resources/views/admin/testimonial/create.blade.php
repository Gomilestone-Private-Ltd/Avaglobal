    ...
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="form-box">
                    <form enctype="multipart/form-data" id="testimonialCreate">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 required">
                                    ...
                                    <input type="text" name="monialname" id="" class="form-control"
                                        value="" placeholder="Testimonial Name">
                                ...
                                <div class="form-group col-md-6 required">
                                    ...
                                    <textarea name="monialtext" id="" class="form-control" value="" placeholder="Add Text Here"></textarea>
...
<script>
    ...
    $('#testimonialCreate').submit(function(e) {
        e.preventDefault();
        ...
        if (selectedFile) {
            var formData = new FormData($("#testimonialCreate")[0]);
            console.log(formData);

            $.ajax({
                url: "{{ url('admin/store/testimonial') }}",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    ...
                    $('#testimonialCreate').trigger("reset");
