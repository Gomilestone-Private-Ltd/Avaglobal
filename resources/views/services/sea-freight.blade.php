...
<div id="page">
    ...
    <div id="fullpage">
        <div class="section servicedetailsection" id="section0" style="padding-bottom: 0px !important;">
        ...
        <div class="section freightcontentparent" id="section1">
            <div class="freightcontentblk">
                ...
                <div>
                    <img class="oceanbg-img" src="{{asset('images/services/oceanbg-resp.jpg')}}" alt="image">
                </div>
            </div>
        </div>
