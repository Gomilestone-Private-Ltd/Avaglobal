        ...
        <div class="authentication">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-sm-12">
                        {{-- <form class="card auth_form">
                            ...
                            <div class="body">
                                ...
                                <a href="index.html" class="btn btn-primary btn-block waves-effect waves-light">GO TO
                                    HOMEPAGE</a>
                    ...
                    <a href="/" class="btn btn-primary" style="margin-left:700px;">Go Back To Homepage</a>
                </div>
            </div>
        </div>
