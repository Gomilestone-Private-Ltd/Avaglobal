...
Route::get('career-detail/{id}/{slug}', [HomeController::class, 'careerDetails'])->name('careerDetails');
Route::get('case-study-detail/{id}/{slug}', [HomeController::class, 'caseStudyDetail'])->name('caseStudyDetail');
